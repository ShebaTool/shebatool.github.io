...
"use strict";require("core-js/features/array/index-of"),require("core-js/features/array/map");var e=t(require("string-hash")),r=t(require("lscache")),a=require("~/lib");function t(e){return e&&e.__esModule?e:{default:e}}var n=window.jQuery,i="//sheba-brain.now.sh/answers";r.default.flushExpired();var o,u=r.default.get("brain-db");function s(r){var t;n(".formulation").each(function(i,o){t=r.map(function(e){return e.q}).indexOf((0,e.default)((0,a.rgxClear)(n(o).find(".qtext").text()))),n(o).find("label").each(function(i,o){(0,e.default)((0,a.rgxClear)(n(o).text().replace(/^(\w\.\s)/gi,"")))===r[t].ra&&n(o).parent().css("background-color","yellow")}),r.splice(t,1)}),n('.othernav :contains("סיום שלב צפייה במשוב")').text()&&!n("a.brain-helper").length&&n.getScript("//sheba-brain.now.sh/post_script").done(function(e){})}u?s(o=u):n.getJSON(i).done(function(e){o=e.db,r.default.set("brain-db",o,60),s(o)}),console.log("BRAIN Helper started...");
