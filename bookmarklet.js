...
"use strict";require("core-js/features/array/index-of"),require("core-js/features/array/map");var e=a(require("string-hash")),t=a(require("lscache")),r=require("~/lib");function a(e){return e&&e.__esModule?e:{default:e}}var n=window.jQuery,o="https://sheba-brain.now.sh/answers";t.default.flushExpired();var i,l=t.default.get("brain-db");function s(){var t=window.artoo,a=t.scrape("div.que",{q:{sel:"div.qtext",data:"html"},ra:function(){return n(this).find(".rightanswer").text().replace(r.regAnswer,"").replace(/(")/g,"")}}),o={t:t.$("title").text()},i=(0,e.default)((0,r.rgxClear)(o.t)),l=[];a.forEach(function(t){l.push({q:(0,e.default)((0,r.rgxClear)(t.q)),ra:(0,e.default)((0,r.rgxClear)(t.ra))})});var s={};s[Date.now()]=l;var u={};u[i]=s;var c={meta:o,data:a,hashed:u};n.post("https://sheba-brain.now.sh",c).done(function(e){e?alert(e):alert("Looks like You dit it right, but something is not working")})}function u(){!n('.othernav :contains("'.concat("סיום שלב צפייה במשוב",'")')).length&&!n('.submitbtns :contains("'.concat("סיום שלב צפייה במשוב",'")')).length||n("a.brain-helper").length||n.getScript("https://medialab.github.io/artoo/public/dist/artoo-latest.min.js").done(function(){n("<a>",{text:"Send Answers to BRAIN Helper",class:"brain-helper",href:"#",click:function(){return s(),!1},style:"background-color: yellow;"}).appendTo("aside .othernav")}).fail(function(){console.log("[FAILED] R2 is broken")})}function c(t){var a;n(".formulation").each(function(o,i){a=t.map(function(e){return e.q}).indexOf((0,e.default)((0,r.rgxClear)(n(i).find(".qtext").text()))),n(i).find("label").each(function(o,i){(0,e.default)((0,r.rgxClear)(n(i).text().replace(/^(\w\.\s)/gi,"")))===t[a].ra&&n(i).parent().css("background-color","yellow")}),t.splice(a,1)})}l?c(i=l):n.getJSON(o).done(function(e){i=e.db,t.default.set("brain-db",i,60),c(i)}),u(),window.showBrain=function(){u()},console.log("BRAIN Helper started...");
