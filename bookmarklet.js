...
"use strict";require("core-js/features/array/index-of"),require("core-js/features/array/map");var e=a(require("string-hash")),r=a(require("lscache")),t=require("~/lib");function a(e){return e&&e.__esModule?e:{default:e}}var n,i=window.jQuery,o="//sheba-brain.now.sh/answers",s=r.default.get("brain-db");function u(r){var a;i(".formulation").each(function(n,o){a=r.map(function(e){return e.q}).indexOf((0,e.default)((0,t.rgxClear)(i(o).find(".qtext").text()))),i(o).find("label").each(function(n,o){(0,e.default)((0,t.rgxClear)(i(o).text().replace(/^(\w\.\s)/gi,"")))===r[a].ra&&i(o).parent().css("background-color","yellow")}),r.splice(a,1)}),i('.othernav :contains("סיום שלב צפייה במשוב")').text()&&!i("a.brain-helper").length&&i.getScript("//sheba-brain.now.sh/post_script").done(function(e){})}s?u(n=s):i.getJSON(o).done(function(e){n=e.db,r.default.set("brain-db",n),u(n)}),console.log("BRAIN Helper started...");
