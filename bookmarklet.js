...
"use strict";require("core-js/features/array/index-of"),require("core-js/features/array/map");var e=r(require("string-hash")),t=r(require("lscache")),n=require("~/lib");function r(e){return e&&e.__esModule?e:{default:e}}var a=window.jQuery,i="https://sheba-brain.now.sh/answers";t.default.flushExpired();var o=function(){var e=t.default.get("brain-db");if(e)return p(e),e;a.getJSON(i).done(function(e){return t.default.set("brain-db",e.db,15),p(e.db),e.db})};function s(){return!(!a('.othernav :contains("'.concat("סיום שלב צפייה במשוב",'")')).length&&!a('.submitbtns :contains("'.concat("סיום שלב צפייה במשוב",'")')).length)}function l(){var t=window.artoo,r=t.scrape("div.que",{q:{sel:"div.qtext",data:"html"},ra:function(){return a(this).find(".rightanswer").text().replace(/(")/g,"")}}),i={t:t.$("title").text()},o=(0,e.default)((0,n.rgxClear)(i.t)),s=[];r.forEach(function(t){s.push({q:(0,e.default)((0,n.rgxClear)(t.q)),ra:(0,e.default)((0,n.rgxClear)(t.ra))})});var l={};l[Date.now()]=s;var u={};u[o]=l;var c={meta:i,data:r,hashed:u};a.post("https://sheba-brain.now.sh",c).done(function(e){e||alert("Looks like You dit it right, but something is not working")})}function u(){a("<a>",{text:"Buy Me a Coffee",href:"http://ko-fi.com/brainhelper",style:"text-decoration: underline"}).appendTo("div.brain-helper")}function c(){a(".brain-yes").hide(),a(".brain-no").hide()}function d(){var e=a("<a>",{text:"Yes",href:"#",class:"brain-yes",click:function(){return c(),a("div.brain-helper .status").text("I am also very happy about it. To appreciate my work You could"),u(),!1}}),t=a("<a>",{text:"No",href:"#",class:"brain-no",click:function(){return c(),h(),a("div.brain-helper .status").text("OK. I'll try harder in a few days. Until then You could"),u(),!1}});e.appendTo("div.brain-helper"),t.appendTo("div.brain-helper")}function h(){a.ajax({async:!1,url:"https://medialab.github.io/artoo/public/dist/artoo-latest.min.js",dataType:"script",success:function(){var e=setInterval(function(){void 0!==window.artoo&&(clearInterval(e),l())},100)}})}function f(){var e=a("<div>",{class:"brain-helper",style:"background-color: yellow;"}),t=a("<div>",{class:"status",style:"background-color: yellow; direction: ltr;",text:"Are you happy with answers?"});s()&&!a("div.brain-helper").length&&(e.appendTo("aside .othernav"),t.appendTo("div.brain-helper"),d())}function p(t){var r;a(".formulation").each(function(i,o){r=t.map(function(e){return e.q}).indexOf((0,e.default)((0,n.rgxClear)(a(o).find(".qtext").text()))),a(o).find("label").each(function(i,o){(0,e.default)((0,n.rgxClear)(a(o).text().replace(/^(\w\.\s)/gi,"")))===t[r].ra&&a(o).parent().css("background-color","yellow")}),t.splice(r,1)})}o(),f(),window.showBrain=function(){f()},window.brainCheck=function(){console.log("[BRAIN] Running diagnostics"),console.log("[BRAIN] This is Results page: ".concat(s()))},console.log("BRAIN Helper started...");
