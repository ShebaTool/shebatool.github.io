...
},{"../internals/global":"dtnl","../internals/shared":"m9a6","../internals/hide":"GCcg","../internals/has":"kMHR","../internals/set-global":"SNLP","../internals/function-to-string":"lo3x","../internals/internal-state":"YxUH"}],"nsr5":[function(require,module,exports) {
...
var e=require("../internals/has"),r=require("../internals/to-indexed-object"),n=require("../internals/array-includes"),i=require("../internals/hidden-keys"),s=n(!1);module.exports=function(n,t){var u,a=r(n),l=0,o=[];for(u in a)!e(i,u)&&e(a,u)&&o.push(u);for(;t.length>l;)e(a,u=t[l++])&&(~s(o,u)||o.push(u));return o};
...
var e=require("../internals/global"),r=require("../internals/object-get-own-property-names"),n=require("../internals/object-get-own-property-symbols"),t=require("../internals/an-object"),o=e.Reflect;module.exports=o&&o.ownKeys||function(e){var o=r.f(t(e)),a=n.f;return a?o.concat(a(e)):o};
},{"../internals/global":"dtnl","../internals/object-get-own-property-names":"sEr8","../internals/object-get-own-property-symbols":"M/iV","../internals/an-object":"ajv4"}],"2PP/":[function(require,module,exports) {
...
},{"../internals/global":"dtnl","../internals/object-get-own-property-descriptor":"fYVJ","../internals/hide":"GCcg","../internals/redefine":"3SfU","../internals/set-global":"SNLP","../internals/copy-constructor-properties":"2PP/","../internals/is-forced":"VB9T"}],"pZgz":[function(require,module,exports) {
"use strict";var n=require("../internals/fails");module.exports=function(r,t){var u=[][r];return!u||!n(function(){u.call(null,t||function(){throw 1},1)})};
},{"../internals/fails":"EwB5"}],"X8Vg":[function(require,module,exports) {
"use strict";var r=require("../internals/export"),e=require("../internals/sloppy-array-method"),i=require("../internals/array-includes"),n=i(!1),t=[].indexOf,a=!!t&&1/[1].indexOf(1,-0)<0,s=e("indexOf");r({target:"Array",proto:!0,forced:a||s},{indexOf:function(r){return a?t.apply(this,arguments)||0:n(this,r,arguments[1])}});
},{"../internals/export":"UqUm","../internals/sloppy-array-method":"pZgz","../internals/array-includes":"EPeP"}],"0LbL":[function(require,module,exports) {
...
require("../../modules/es.array.index-of");var e=require("../../internals/entry-unbind");module.exports=e("Array","indexOf");
...
},{"../internals/global":"dtnl","../internals/shared":"m9a6","../internals/uid":"80dz","../internals/native-symbol":"wedg"}],"Ow6/":[function(require,module,exports) {
...
"use strict";var r=require("../internals/export"),e=require("../internals/array-methods"),t=require("../internals/array-method-has-species-support"),a=e(1),s=t("map");r({target:"Array",proto:!0,forced:!s},{map:function(r){return a(this,r,arguments[1])}});
},{"../internals/export":"UqUm","../internals/array-methods":"fvPA","../internals/array-method-has-species-support":"xYl4"}],"g4SH":[function(require,module,exports) {
require("../../modules/es.array.map");var r=require("../../internals/entry-unbind");module.exports=r("Array","map");
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.rgxClear=s,exports.regSpecialSymbols=exports.regAnswer=void 0;var e=/^התשובההנכונה/,r=/[!:@#$%^&*)(,?+=._-\s]+/g;function s(s){return s.replace(r,"").replace(e,"")}exports.regSpecialSymbols=r,exports.regAnswer=e;
},{}],"Focm":[function(require,module,exports) {
"use strict";require("core-js/features/array/index-of"),require("core-js/features/array/map");var e=r(require("string-hash")),t=r(require("lscache")),n=require("~/lib");function r(e){return e&&e.__esModule?e:{default:e}}var a=window.jQuery,i="https://sheba-brain.now.sh/answers";t.default.flushExpired();var o=function(e){var n=t.default.get("brain-db");return n?(e&&(n=n.concat(e),t.default.set("brain-db",n,15)),p(n),n):void a.getJSON(i).done(function(e){return t.default.set("brain-db",e.db,15),p(e.db),e.db})};function s(){return!(!a('.othernav :contains("'.concat("סיום שלב צפייה במשוב",'")')).length&&!a('.submitbtns :contains("'.concat("סיום שלב צפייה במשוב",'")')).length)}function l(){var t=window.artoo,r=t.scrape("div.que",{q:{sel:"div.qtext",data:"html"},ra:function(){return a(this).find(".rightanswer").text().replace(/(")/g,"")}}),i={t:t.$("title").text()},o=(0,e.default)((0,n.rgxClear)(i.t)),s=[];r.forEach(function(t){s.push({q:(0,e.default)((0,n.rgxClear)(t.q)),ra:(0,e.default)((0,n.rgxClear)(t.ra))})});var l={};l[Date.now()]=s;var u={};u[o]=l;var c={meta:i,data:r,hashed:u};return a.post("https://sheba-brain.now.sh",c).done(function(e){e||alert("Looks like You dit it right, but something is not working")}),s}function u(){a("<a>",{text:"Buy Me a Coffee",href:"http://ko-fi.com/brainhelper",style:"text-decoration: underline"}).appendTo("div.brain-helper")}function c(){a(".brain-yes").hide(),a(".brain-no").hide()}function d(){var e=a("<a>",{text:"Yes",href:"#",class:"brain-yes",click:function(){return c(),a("div.brain-helper .status").text("I am also very happy about it. To appreciate my work You could"),u(),!1}}),t=a("<a>",{text:"No",href:"#",class:"brain-no",click:function(){return c(),h(),a("div.brain-helper .status").text("OK. I'll try harder in a few days. Just kidding. All the right answers should be marked now. The same thing should be during the test."),u(),!1}});e.appendTo("div.brain-helper"),t.appendTo("div.brain-helper")}function h(){a.ajax({async:!1,url:"https://medialab.github.io/artoo/public/dist/artoo-latest.min.js",dataType:"script",success:function(){var e=setInterval(function(){void 0!==window.artoo&&(clearInterval(e),o(l()))},100)}})}function f(){var e=a("<div>",{class:"brain-helper",style:"background-color: yellow;"}),t=a("<div>",{class:"status",style:"background-color: yellow; direction: ltr;",text:"Are you happy with answers?"});s()&&!a("div.brain-helper").length&&(e.appendTo("aside .othernav"),t.appendTo("div.brain-helper"),d())}function p(t){var r;a(".formulation").each(function(i,o){r=t.map(function(e){return e.q}).indexOf((0,e.default)((0,n.rgxClear)(a(o).find(".qtext").text()))),console.log(r),-1!==r&&(a(o).find("label").each(function(i,o){(0,e.default)((0,n.rgxClear)(a(o).text().replace(/^(\w\.\s)/gi,"")))===t[r].ra&&a(o).parent().css("background-color","yellow")}),t.splice(r,1))})}o(),f(),window.showBrain=function(){f()},window.brainCheck=function(){console.log("[BRAIN] Running diagnostics"),console.log("[BRAIN] This is Results page: ".concat(s()))},console.log("BRAIN Helper loaded...");
