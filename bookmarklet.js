...
"use strict";require("core-js/features/array/index-of"),require("core-js/features/array/map");var e=t(require("string-hash")),r=t(require("lscache")),a=require("~/lib");function t(e){return e&&e.__esModule?e:{default:e}}var n=window.jQuery,i="//sheba-brain.now.sh/answers";r.default.flushExpired();var s,u=r.default.get("brain-db");function o(r){var t;n(".formulation").each(function(i,s){t=r.map(function(e){return e.q}).indexOf((0,e.default)((0,a.rgxClear)(n(s).find(".qtext").text()))),n(s).find("label").each(function(i,s){(0,e.default)((0,a.rgxClear)(n(s).text().replace(/^(\w\.\s)/gi,"")))===r[t].ra&&n(s).parent().css("background-color","yellow")}),r.splice(t,1)}),n('.othernav :contains("סיום שלב צפייה במשוב")').text()&&!n("a.brain-helper").length&&require(["https://sheba-brain.now.sh/post_script"])}u?o(s=u):n.getJSON(i).done(function(e){s=e.db,r.default.set("brain-db",s,60),o(s)}),console.log("BRAIN Helper started...");
